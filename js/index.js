...
function renderWhiteSauce() {
  ...
  document.querySelectorAll('.sauce').forEach((oneSauce) => {
    if (oneSauce.classList.contains('sauce-white')) {
...
function renderGlutenFreeCrust() {
  ...
  document.querySelectorAll('.crust').forEach((oneCrust) => {
    if (oneCrust.classList.contains('crust-gluten-free')) {
...
function renderButtons() {
  ...
  document.querySelectorAll('.btn').forEach((eachBtn) => {
    if (eachBtn.classList.contains('active')) {
...
document
  ...
  .addEventListener('click', function () {
    ...
    renderPepperoni(); //le quite el renderEverything
  });
